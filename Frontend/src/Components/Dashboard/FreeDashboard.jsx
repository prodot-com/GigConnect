...
const FreelancerDashboard = () => {
  ...
  <div className="relative z-10 flex flex-col md:flex-row min-h-screen font-mono">
    {/* Sidebar */}
    <div className="w-full md:w-1/4 p-4 md:p-6 sticky top-0 h-auto md:h-screen">
      <h2 className="text-2xl font-bold mb-6 text-indigo-600 tracking-tight">
        Freelancer-Dashboard
      </h2>

      <div className="bg-white border-2 shadow-xl p-4 md:p-6 mb-8">
        <ul className="space-y-4 md:space-y-7">
          <li>
            <button
              onClick={() => navigate("/all-gigs")}
              className="w-full text-left px-3 md:px-4 py-2 md:py-3 hover:shadow-lg bg-blue-600 text-white border-2 border-black cursor-pointer hover:bg-blue-700 transition-colors duration-200 shadow-sm"
            >
              Browse Gigs
            </button>
          </li>
          <li>
            <button
              ...
              className="w-full text-left px-3 md:px-4 py-2 md:py-3 hover:shadow-lg bg-green-600 text-white border-2 border-black cursor-pointer hover:bg-green-700 transition-colors duration-200 shadow-sm"
            >
              My Applications
            </button>
          </li>
      ...
      {/* Quote Section */}
      <div className="relative min-h-40 md:min-h-1/2 border-2 p-6 overflow-hidden flex items-center justify-center">
        <div
    ...
    <div className="flex-1 p-4 md:p-10">
      ...
      <div className="bg-white border-2 shadow-xl p-4 md:p-6 mb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <h2 className="text-xl md:text-3xl font-semibold text-gray-800">{freelancer?.name}</h2>
        </div>
        ...
        <div className="mt-6">
          <h3 className="text-lg md:text-xl font-semibold text-indigo-700">Skills</h3>
          <div className="flex flex-wrap gap-2 mt-2">
            {freelancer?.skills?.length > 0 ? (
              freelancer.skills.map((skill, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm md:text-base font-medium hover:bg-indigo-200 transition-colors duration-200"
                >
                  {skill}
                </span>
              ))
        ...
        <div className="mt-6">
          <h3 className="text-lg md:text-xl font-semibold text-indigo-700">Portfolio</h3>
        ...
        {/* Service Rate */}
        <div className="mt-6">
          <h3 className="text-lg md:text-xl font-semibold text-indigo-700">Service Rate</h3>
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 w-full">
        <div
          ...
          onClick={() => navigate("/all-gigs")}
        >
          <h3 className="text-lg md:text-xl font-semibold text-gray-800">Browse Gigs</h3>
        ...
        <div
          ...
          onClick={() => navigate("/my-applications")}
        >
          <h3 className="text-lg md:text-xl font-semibold text-gray-800">My Applications</h3>
          <p className="text-gray-600 mt-2">
  ...
  {/* Footer */}
  <div className="flex flex-col md:flex-row items-center justify-center border-t-2 border-black font-bold bg-gray-400 p-2 md:p-4">
    <Copyright />
    <p className="p-2 pl-0 text-center md:text-left">2025 GigConnect. All rights reserved.</p>
  </div>
</div>
